...
function Update() {
  ...
  useEffect(()=>{
    ...
    const fetchData = async ()=>{
      const res = await axios.get(`https://pink-tiny-rattlesnake.cyclic.cloud//api/posts/${id}`)
  ...
  const handleSubmit =async (e)=>{
    ...
    toggleProcess()
    const res = await axios.patch(`https://pink-tiny-rattlesnake.cyclic.cloud//api/posts/${id}`,{title,description:des,code,author,tags:array,email})
    toggleProcess()
